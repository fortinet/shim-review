...
www.fortinet.com
We are a well-known firewall vendor.
...
Subject: C=US, S=California, L=Sunnyvale, O = Fortinet, Inc. , CN = Fortinet, Inc., SERIALNUMBER = 3321792
```
...
*******************************************************************************
- Name: Colin Wen
- Position: Senior Director Software Developement
...
*******************************************************************************
https://github.com/fortinet/shim-review
...
*******************************************************************************
Kernel is compiled with lockdown enforced CONFIG_SECURITY_LOCKDOWN=y.
...
*******************************************************************************
Our last shim binary also only loads GRUB2.12 which is not exposed to above CVEs.
...
*******************************************************************************
1. changed shim version from 15.8 to 16.1
2. changed the embedded certificate.

*******************************************************************************
### What is the SHA256 hash of your final shim binary?
*******************************************************************************
3e88d13d467e94a5244f6760652dbbdcf7d5188e58ac0f09ede9b7d4fa67c4ac  build-x86_64/shimx64.efi
99bfc7c45fc61655d2dcd966bf43934096c0f5ef3feb3fb6b1f12e9e0542bb3e  build-aarch64/shimaa64.efi
...
about this.
*******************************************************************************
Yes, the certificate includes X509v3 Basic Constraints to say that it is a CA.
...
shim.fortios,2,Fortinet,shim,16.1,https://github.com/fortinet/shim-review  
...
*******************************************************************************
Have not contributed yet, but plan to help.
